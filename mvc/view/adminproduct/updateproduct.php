        ...
        <form action='' method=post enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name='inputAlias' value='<?php echo $oldproduct['alias'];
                                                                    ?>'></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="number" name='inputPrice' step='0.01' max=3000 min=1 value=<?php echo $oldproduct['price'] ?>></td>
                </tr>
                <tr>
