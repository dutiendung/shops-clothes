...
<div class="col-md-9 m-auto">
    <h2 class="text-center bg-secondary text-white" >ADD PRODUCT</h2>
    ...
    <div class="row">
        <form action='' method=post enctype="multipart/form-data">
            <table>
                <tr>
                    <td class=col-md3><label for="inputProductName">ProductName</label></td>
                    ...
                    <td>
                        <select name="inputCatId" id="inputCatId">
                            <?php foreach ($cats as $cat) { ?>
                                <option value="<?php echo $cat['catId'] ?>"><?php echo $cat['catName'] ?></o ption>
                                <?php } ?>
                        </select>
                    </td>
                </tr>
